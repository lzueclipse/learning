...
gcc -shared -fPIC -Wl,-soname,libopensource.so.1 -o libopensource.so.1.0 opensource.o
...
gcc -fPIC -c -o opensource.o opensource.c
gcc -shared -fPIC -Wl,-soname,libopensource.so.2 -o libopensource.so.2.0 opensource.o
